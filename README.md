...
## How to Play
Use your arrow keys to move the tiles. When two tiles with the same Kermit touch, they merge into one!

If you are confused by the order, try to embody the spirit of Kermit (or enable colored tile outlines — the order is a rainbow).
